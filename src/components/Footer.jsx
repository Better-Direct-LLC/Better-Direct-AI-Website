        ...
        <div className="bg-white rounded-2xl shadow-xl px-8 py-8 flex flex-col md:flex-row items-center md:items-stretch gap-8 md:gap-0 relative">
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 items-center justify-items-center md:pl-12">
            <div className="flex flex-col gap-2 items-center">
              <Link to="/about-us" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">About us</Link>
              <Link to="/buy-now" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Buy Now</Link>
              <Link to="/careers" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Careers</Link>
              <Link to="/contact-us" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Contact us</Link>
            </div>
            <div className="flex flex-col gap-2 items-center">
              <Link to="/contracts" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Contracts</Link>
              <Link to="/" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Home</Link>
              <Link to="/services" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Services</Link>
              <Link to="/success-stories" className="text-blue-600 hover:text-blue-800 font-semibold text-sm transition-colors">Success Stories</Link>
            </div>
          </div>
        </div>
