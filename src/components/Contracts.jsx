          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                  ...
                  <div className="flex justify-center gap-2 pb-4">
                    {carouselSlides.map((_, index) => (
                      <button
                        ...
                        className={`rounded-full transition-all duration-300 border-2 focus:outline-none ${currentSlide === index
                ...
                <button
                  onClick={nextSlide}
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-white bg-opacity-80 rounded-full shadow-lg hover:bg-opacity-100 hover:scale-110 transition-all duration-300 group cursor-pointer"
            ...
            {contracts.map((contract, index) => (
              <div key={index} className="bg-gray-50 rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <Link
                  ...
                  className="inline-block px-6 py-3 border-2 font-medium rounded transition-all hover:scale-105 duration-300"
                  ...
                  <div className="flex justify-center gap-2 pb-6">
                    {stateSlides.map((_, index) => (
                      <button
                        ...
                        className={`rounded-full transition-all duration-300 border-2 focus:outline-none ${currentStateSlide === index
                            ? 'bg-[#0570c6] border-white shadow-lg w-4 h-4 scale-125'
                            : 'bg-white/50 border-transparent opacity-70 w-3 h-3'
                          }`}
                        aria-label={`Go to slide ${index + 1}`}
