                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <div className="space-y-2 text-blue-600">
                            <p>
                                <strong>Phone:</strong> <a href="tel:4809213858" className="text-blue-700 underline hover:text-blue-800">480-921-3858</a> Ext 12
                            </p>
                            <p>
                                <strong>Email:</strong> <a href="mailto:ites-4h.warranty@betterdirect.com" className="text-blue-700 underline hover:text-blue-800">ites-4h.warranty@betterdirect.com</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gray-50 rounded-lg shadow-lg p-8">
                        ...
                        <div className="space-y-3 text-blue-600 mb-6">
                            <p>
                                <strong>Chase Cai –</strong> <a href="tel:4809213858" className="text-blue-700 underline hover:text-blue-800">480-921-3858</a> Ext 320 | <a href="mailto:chase@betterdirect.com" className="text-blue-700 underline hover:text-blue-800">chase@betterdirect.com</a>
                            </p>
                            <p>
                                <strong>Diana Zhong –</strong> <a href="tel:4809213858" className="text-blue-700 underline hover:text-blue-800">480-921-3858</a> Ext 275 | <a href="mailto:diana@betterdirect.com" className="text-blue-700 underline hover:text-blue-800">diana@betterdirect.com</a>
                            </p>
                        </div>
